  ...
  return (
    <div className='page-wrap'>
        <div className="userInfo">
            <span className='userInfo_detail'>회원가입</span>
            <span className='userInfo_detail'>로그인</span>
            <span className='userInfo_detail'>고객센터</span>
        </div>
        <div className="header_title">
            ...
            <Link className='category_item' to='/'>
                ...
                alt='마켓컬리 로고'
                className='logo' />
                <h1 className='korean_title'>마켓컬리</h1>
            </Link>
            </div>
            ...
            <div className="title_icon">
                <i className="fa-sharp fa-solid fa-location-dot title_icon_item"></i>
                <i className="fa-regular fa-heart title_icon_item"></i>
                <i className="fa-sharp fa-solid fa-cart-shopping title_icon_item"></i>
            </div>
        </div>
        <div className="categories">
            <ul>
                ...
                <li className="category_nav_items">
                    <Link className='category_item' to='/best'>
                        베스트
                    </Link>
                </li>
                <li className="category_nav_items">
                    <Link className='category_item' to='/time-sales'>
                        알뜰쇼핑
                    </Link>
                </li>
                <li className="category_nav_items">
                    <Link className='category_item' to='/benefit'>
                        특가/혜택
                    </Link>
                </li>
                <li className="category_nav_items">
